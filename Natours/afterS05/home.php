    ...
    <body>
        ...
        <header class="header">
            <div class="header__logo-box">
                <img src="img/logo-white.png" alt="Logo" class="header__logo" style="height: 150px; width: 150px;">
            </div>

            <div class="header__text-box">
                <h1 class="heading-primary">
                    <span class="heading-primary--main">Book Share</span>
                   <!--  <span class="heading-primary--sub"></span> -->
                </h1>

                <a href="Loginv3/login.php" class="btn btn--white btn--animated" >Log-in</a>
                 <a href="register/register.php" class="btn btn--white btn--animated "style="margin-left: 20px;">Register</a>
            </div>
        </header>
            ...
            <section class="section-about">
                <div class="u-center-text u-margin-bottom-big">
                    <h2 class="heading-secondary">
                        Digital Plateform For Book Sharing
                    </h2>
                </div>
        ...
        <header class="header">
            ...
            <div class="header__text-box">
               ...
               <!--  </h1>
                ...
                <a href="#section-tours" class="btn btn--white btn--animated">Log-in</a>
                 <a href="#section-tours" class="btn btn--white btn--animated">Register</a>
            </div>
        </header>
